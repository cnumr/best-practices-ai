...
updatedAt: 2026-04-17T07:23:59.112Z
language: fr
published: true
refType: RIA
versions:
...
validations:
  - rule: >-
      Le nombre d'entrainements de modèle sans qualification de la qualité et de
      la taille du jeu d'entrainement est de
    maxValue: '0'
---

## Description

L’entrainement étant une étape potentiellement très coûteuse. Limiter la taille du jeu de données d’entraînement a une
